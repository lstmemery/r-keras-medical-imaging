...
<img src="./img/convolution.gif" height="80%"" width="80%" alt="https://hackernoon.com/visualizing-parts-of-convolutional-neural-networks-using-keras-and-cats-5cc01b214e59">
...
<aside class="notes">This is a very small training set. You should probably use cross-validaiton instead</aside>
...
<img src="../data/TRAIN/openI_abd_xray/openI_1.png" height="125%"" width="125%" alt="">

## Chest

<img src="../data/TRAIN/openI_CXR/3_IM-1384-1001.png" height="125%"" width="125%" alt="">
...
<aside class="notes">Rescaling brings all the values of pixels in down to a maximum of one</aside>
...
<aside class="notes">Dropout randomly turns activations to 0 during training to reduce overfitting. Seems crazy but it works.</aside>
