...
- Adjust these numbers using the **chain rule** for derivatives
...
- CNNs are neural networks that work very well for images
- The idea is that basic features of an image (edges etc.) are useful to know about anywhere in the image
