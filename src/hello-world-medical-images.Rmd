...
- The idea is that basic features of an image (edges etc.) are useful to know about
- Combinations of basic features can make more complex features further into the network
...
![http://cs231n.github.io/understanding-cnn/](./img/src/1st-layer.jpeg)
