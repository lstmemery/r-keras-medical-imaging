...
```{r}
train_generator$get_random_transform()
```
...
- These architectures are tested on ImageNet, a global competition to classify millions of images into thousands of categories
